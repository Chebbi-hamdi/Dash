            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" fill="" />
                    <path
                      d="M13 7 A4 4 0 0 1 9 11 A4 4 0 0 1 5 7 A4 4 0 0 1 13 7 z"
                      fill=""
                    />
                    <path
                      d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 012 8.75"
                      fill=""
                    />
                  </svg>
                  Users
              ...
              <li>
                <NavLink
                  to="/discussions"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('discussion') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
      ...
      />                  </svg>
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M4 2a2 2 0 00-2 2v10h2V4h10V2H4m4 4a2 2 0 00-2 2v10h2V8h10V6H8m12 6v8h-8v-8h8m0-2h-8a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-8a2 2 0 00-2-2m-1 7h-2v2h-2v-2h-2v-2h2v-2h2v2h2v2z" />
                  </svg>
                  Sub Category
                </NavLink>
              </li>
              {/* <!-- Menu Item subsubCategory --> */}
              <li>
                <NavLink
                  to="/subsubCategorys"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('sub-sub-category') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/emails"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('emails') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M10.1249 2.5031H16.8749C17.2124 2.5031 17.5218 2.22185 17.5218 1.85623C17.5218 1.4906 17.2405 1.20935 16  874 1.85623 1.20935 1.40625 1.20935 1.77187 1.20935H16.875C17.2125 1.20935 17.5219 1.4906 17.5219 1.85623C17.5219 2.22185 17.2405 2.5031 16.8749 2.5031Z"
                      fill=""
                    />
                  </svg>
                  Chat
