...
import {
  useGetAllSubTask,
} from '../../hooks/costumHooksTaskType';
interface Item {
  _id: string;
  title?: string;
  text?: string;
...
const MultiSubTask: React.FC<DropdownProps> = ({ id, onSelectedChange }) => {
  ...
  const { data, isLoading } = useGetAllSubTask('STT', 'STT');
